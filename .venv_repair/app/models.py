...
class Report(db.Model):
    ...
    call_type_slug = db.Column(db.String(120), nullable=True, index=True)
    facts_text = db.Column(db.Text, nullable=True)
    narrative_text = db.Column(db.Text, nullable=True)
    blotter_text = db.Column(db.Text, nullable=True)
    paperwork_json = db.Column(db.Text, nullable=True)
    officer_notes = db.Column(db.Text, nullable=True)
    created_at = db.Column(db.DateTime, default=utcnow_naive)
    updated_at = db.Column(db.DateTime, default=utcnow_naive)
