...
def _dashboard_card_catalog():
    cards = [
        ...
        },
        {
            ...
            'description': 'Begin a standard incident report',
            'icon': 'report',
        ...
        },
        {
            'id': 'forms_library',
            'label': 'Forms Library',
            'description': 'Complete official forms and PDF packets',
            'icon': 'forms',
        ...
        },
        {
            ...
            'description': 'Officer diagrams and investigator reconstruction cases',
            'icon': 'report',
        ...
        },
        {
            'id': 'bodycam_mode',
            'label': 'Body Cam Mode',
            'description': 'Record browser-supported video, audio, and transcript notes',
            'icon': 'report',
        ...
        },
        {
            ...
            'description': 'Review saved bodycam recordings and transcripts',
            'icon': 'saved',
    ...
    return [
        {
            ...
            'items': [
                ...
                {'label': 'Start New Report', 'detail': 'Begin a standard report shell', 'endpoint': 'reports.new_report'},
                ...
                {'label': 'Accident Tools', 'detail': 'Officer diagrams and reconstruction cases', 'endpoint': 'reports.accidents'},
        ...
        },
        {
            ...
            'items': [
                {'label': 'Forms Library', 'detail': 'Official forms and PDF workflows', 'endpoint': 'forms.list_forms'},
                ...
                {'label': 'Body Cam Mode', 'detail': 'Record footage and transcript notes', 'endpoint': 'bodycam.new_recording'},
                {'label': 'Bodycam Footage', 'detail': 'Saved recordings and transcripts', 'endpoint': 'bodycam.library'},
                {'label': 'My Profile', 'detail': 'Contact info and emergency contacts', 'endpoint': 'officers.profile'},
