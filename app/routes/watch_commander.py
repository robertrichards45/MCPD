...
_MAP_ROLES = {
    ROLE_PATROL_OFFICER, ROLE_DESK_SGT, ROLE_WATCH_COMMANDER,
    ROLE_OFFICER, ROLE_FIELD_TRAINING,
    ROLE_K9_OFFICER, ROLE_K9_SERGEANT, ROLE_KENNEL_MASTER,
    ROLE_CVI_OFFICER, ROLE_CVI_LIEUTENANT,
    ROLE_SRT_OFFICER, ROLE_SRT_COMMANDER,
    ROLE_AID_OFFICER, ROLE_AID_LIEUTENANT,
    ROLE_TRUCK_GATE_PATROL_OFFICER, ROLE_TRUCK_GATE_WATCH_COMMANDER,
    ROLE_RFI_PATROL_OFFICER, ROLE_RFI_WATCH_COMMANDER,
}
