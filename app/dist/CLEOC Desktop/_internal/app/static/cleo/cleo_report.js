...
async function loadReport(pageKey) {
  ...
  if (json && json.editable === false) {
    ...
    alert('This CLEOC report is read-only because it has already been submitted. Review it from the summary page or wait for it to be returned for corrections.');
  }
...
function initLegacyHomePopup() {
  ...
  reopenBtn.textContent = 'Open CLEOC Window';
