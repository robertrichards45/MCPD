...
class User(UserMixin, db.Model):
    ...
    pending_approval = db.Column(db.Boolean, default=False, nullable=False, index=True)
    ...
    builder_mode_granted_by = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=True, index=True)
